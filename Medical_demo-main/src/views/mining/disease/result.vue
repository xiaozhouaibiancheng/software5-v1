<template>
  <div>
    <el-header>
      <h3>疾病关联关系挖掘</h3>
      <span style="margin-top: 10px">注释：此模块挖掘疾病之间的关联关系，并以关系图形式展示</span>
      ...
      <el-col :span="10">
        <el-card style="margin-right: 10px; height: 480px; margin-top: 20px" v-loading="loading">
          <div style="margin-top: 10px">
            ...
            <span>注释：表中每行显示与所选疾病相关联的疾病和其对应的权重，在右侧进行图谱展示</span>
      ...
      <el-col :span="7">
        <el-card style="height: 480px;margin-top: 20px" v-loading="loading">
          <div slot="header" class="clearfix">
            ...
            <br>
            <span>对应于左侧疾病关联表格</span>
          </div>
          <div id="chart2" style="width: 100%; height: 350px"></div>
        </el-card>
      </el-col>
    </el-row>
    <div style="margin-top: 30px"  id="min3">
      <el-row>
        <el-col :span="24">
          <el-card
            shadow="hover"
          ...
          >
            <div style="width: 1100px">
              <h3>疾病关联图</h3>
              <el-button type="success" style="margin-left: 1200px" @click="getPdf3()" round>导出结果</el-button>
              ...
              <br>
              <span>注释：根据关联边权重选择需要展示的关联数量,同时可点击下方疾病分类对图谱进行过滤</span>
            </div>
            <div
              id="chart4"
...
export default {
  ...
  created() {
    ...
    this.diseases1 = this.$route.query.diseases
    this.factors1 = this.$route.query.factors
    this.association1 = this.$route.query.association
  ...
  methods: {
    prev() {
      this.$router.push({ path: '/sideBar/mining', query: { form: this.form, diseasesShow:this.diseasesShow1, factorsShow:this.factorsShow1, diseaseShow:this.diseaseShow1, factorShow:this.factorShow1, flag:this.flag2, diseases:this.diseases1, factors:this.factors1,association:this.association1} })
      console.log("打印")
      console.log(this.$route.query)
    },
    prev1(){
